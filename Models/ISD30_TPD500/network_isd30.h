...
#ifndef AI_NETWORK_ISD30_H
#define AI_NETWORK_ISD30_H
#pragma once

#include "network_isd30_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_ISD30_MODEL_NAME          "network_isd30"
#define AI_NETWORK_ISD30_ORIGIN_MODEL_NAME   "model15"

/******************************************************************************/
#define AI_NETWORK_ISD30_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_ISD30_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_ISD30_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_ISD30_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_ISD30_IN \
  ai_network_isd30_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_ISD30_IN_SIZE { \
  AI_NETWORK_ISD30_IN_1_SIZE, \
}
#define AI_NETWORK_ISD30_IN_SIZE_BYTES { \
  AI_NETWORK_ISD30_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_ISD30_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_ISD30_IN_1_HEIGHT      (15)
#define AI_NETWORK_ISD30_IN_1_CHANNEL     (4)
#define AI_NETWORK_ISD30_IN_1_SIZE        (15 * 4)
#define AI_NETWORK_ISD30_IN_1_SIZE_BYTES  (240)

/******************************************************************************/
#define AI_NETWORK_ISD30_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_ISD30_OUT \
  ai_network_isd30_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_ISD30_OUT_SIZE { \
  AI_NETWORK_ISD30_OUT_1_SIZE, \
}
#define AI_NETWORK_ISD30_OUT_SIZE_BYTES { \
  AI_NETWORK_ISD30_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_ISD30_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_ISD30_OUT_1_CHANNEL     (1)
#define AI_NETWORK_ISD30_OUT_1_SIZE        (1)
#define AI_NETWORK_ISD30_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_NETWORK_ISD30_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_isd30
 ...
 * @ref ai_network_isd30_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_isd30_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_isd30_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_isd30_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_ISD30_*
 * defines into file @ref network_isd30.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_isd30_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_ISD30_H */
