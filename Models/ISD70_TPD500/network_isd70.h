...
#ifndef AI_NETWORK_ISD70_H
#define AI_NETWORK_ISD70_H
#pragma once

#include "network_isd70_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_ISD70_MODEL_NAME          "network_isd70"
#define AI_NETWORK_ISD70_ORIGIN_MODEL_NAME   "model35"

/******************************************************************************/
#define AI_NETWORK_ISD70_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_ISD70_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_ISD70_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_ISD70_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_ISD70_IN \
  ai_network_isd70_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_ISD70_IN_SIZE { \
  AI_NETWORK_ISD70_IN_1_SIZE, \
}
#define AI_NETWORK_ISD70_IN_SIZE_BYTES { \
  AI_NETWORK_ISD70_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_ISD70_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_ISD70_IN_1_HEIGHT      (35)
#define AI_NETWORK_ISD70_IN_1_CHANNEL     (4)
#define AI_NETWORK_ISD70_IN_1_SIZE        (35 * 4)
#define AI_NETWORK_ISD70_IN_1_SIZE_BYTES  (560)

/******************************************************************************/
#define AI_NETWORK_ISD70_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_ISD70_OUT \
  ai_network_isd70_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_ISD70_OUT_SIZE { \
  AI_NETWORK_ISD70_OUT_1_SIZE, \
}
#define AI_NETWORK_ISD70_OUT_SIZE_BYTES { \
  AI_NETWORK_ISD70_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_ISD70_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_ISD70_OUT_1_CHANNEL     (1)
#define AI_NETWORK_ISD70_OUT_1_SIZE        (1)
#define AI_NETWORK_ISD70_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_NETWORK_ISD70_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_isd70
 ...
 * @ref ai_network_isd70_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_isd70_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_isd70_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_isd70_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_ISD70_*
 * defines into file @ref network_isd70.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_isd70_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_ISD70_H */
