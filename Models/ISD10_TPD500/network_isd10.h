...
#ifndef AI_NETWORK_ISD10_H
#define AI_NETWORK_ISD10_H
#pragma once

#include "network_isd10_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_ISD10_MODEL_NAME          "network_isd10"
#define AI_NETWORK_ISD10_ORIGIN_MODEL_NAME   "model5"

/******************************************************************************/
#define AI_NETWORK_ISD10_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_ISD10_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_ISD10_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_ISD10_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_ISD10_IN \
  ai_network_isd10_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_ISD10_IN_SIZE { \
  AI_NETWORK_ISD10_IN_1_SIZE, \
}
#define AI_NETWORK_ISD10_IN_SIZE_BYTES { \
  AI_NETWORK_ISD10_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_ISD10_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_ISD10_IN_1_HEIGHT      (5)
#define AI_NETWORK_ISD10_IN_1_CHANNEL     (4)
#define AI_NETWORK_ISD10_IN_1_SIZE        (5 * 4)
#define AI_NETWORK_ISD10_IN_1_SIZE_BYTES  (80)

/******************************************************************************/
#define AI_NETWORK_ISD10_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_ISD10_OUT \
  ai_network_isd10_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_ISD10_OUT_SIZE { \
  AI_NETWORK_ISD10_OUT_1_SIZE, \
}
#define AI_NETWORK_ISD10_OUT_SIZE_BYTES { \
  AI_NETWORK_ISD10_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_ISD10_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_ISD10_OUT_1_CHANNEL     (1)
#define AI_NETWORK_ISD10_OUT_1_SIZE        (1)
#define AI_NETWORK_ISD10_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_NETWORK_ISD10_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_isd10
 ...
 * @ref ai_network_isd10_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_isd10_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_isd10_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_isd10_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_ISD10_*
 * defines into file @ref network_isd10.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_isd10_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_ISD10_H */
